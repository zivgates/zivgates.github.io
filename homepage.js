...
function about() {
    ...
    document.getElementById("text2").textContent = "This is the homepage, As I'm Planning to add more pages to the website in the future.";
...
function aboutMe() {
    ...
    document.getElementById("text2").textContent = "I'm Mainly a C/C++ Programmer, But I also enjoy making Frontend For Websites.";
